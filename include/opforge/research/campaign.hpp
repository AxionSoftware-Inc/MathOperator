...
struct CampaignConfig { CampaignMode mode{CampaignMode::StructuralExploration}; CampaignBudget budget{}; std::string campaign_id{"C-open-001"}, atlas_snapshot{"v0.25-open-search-baseline"}, target{"none"}; bool ai_enabled{false}, freeze_atlas{true}; };
struct CampaignState { std::string id, version{"0.1"}, atlas_snapshot; CampaignMode mode{CampaignMode::StructuralExploration}; int cycle{0}, actions_executed{0}; std::vector<std::string> active_queue; double budget_used{0}; bool stopped{false}; };
